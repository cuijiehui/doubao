...
import sdk_sample.sdk.activity.*;
...
//	private boolean mTestDelayElapsed; // add a timer for testing
	...
	public void onCreate() {
		...
		mNotif = Compatibility.createNotification(this, mNotificationTitle, "", R.drawable.logo, IC_LEVEL_OFFLINE, bm, mNotifContentIntent, true);
...
//				}
	...
	public void displayMessageNotification(String fromSipUri, String fromName, String message) {
		Intent notifIntent = new Intent(this, LockListActivity.class);
