...
public class Request {
	...
	//远程开门
	public static JSONObject longOpenDoor(String data) throws JSONException
	{
		final JSONObject json = new JSONObject();
		json.put("access_token", "b43d991e1ee06fbcf0dc1ed8b75e560d29a8530L59904e631568c6bd");
		json.put("operation", "OPEN_DOOR");
		json.put("data" , new JSONObject(data));
		JSONObject json_ret = DemoHttps.connectPost2(longOpenDoorAPI, json);
		return json_ret;
	}
