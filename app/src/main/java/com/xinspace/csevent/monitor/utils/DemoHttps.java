package com.xinspace.csevent.monitor.utils;
...
public class DemoHttps {
	public static HttpClient getHttpsClient() {
		...
		schReg.register(new Scheme("https", SSLSocketFactory.getSocketFactory(), 9099));
	...
	public static JSONObject connectPost(String url,JSONObject parameters) 
	{
		...
		try {
			HttpEntity entity_content = new StringEntity(parameters.toString(),HTTP.UTF_8); //设置字符集
	...
	public static JSONObject connectPost2(String url,JSONObject parameters)
	{
		if (url == null || parameters == null)
		{
			return null;
...
//		httpPost.addHeader("Authorization", "b43d991e1ee06fbcf0dc1ed8b75e560d29a8530L59904e631568c6bd"); //认证token
