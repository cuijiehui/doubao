...
import com.xinspace.csevent.monitor.utils.DateUtils;

public class MonthDateView extends View {
	private static final int NUM_COLUMNS = 7;
	private static final int NUM_ROWS = 6;
	private Paint mPaint;
	private int mDayColor = Color.parseColor("#ffffff");      	//天颜色
	private int mSelectDayColor = Color.parseColor("#ffffff"); 	//选中天的颜色
	private int mSelectBGColor = Color.parseColor("#ea5205");  	//选中背景颜色
	private int mCurrentColor = Color.parseColor("#ff0000");    //今天字体颜色
	...
	protected void onDraw(Canvas canvas) {
		...
		String dayString;
		int mMonthDays = DateUtils.getMonthDays(mSelYear, mSelMonth);     //月
		int weekNumber = DateUtils.getFirstDayWeek(mSelYear, mSelMonth);  //星期
