 ...
 *  已揭晓
 */
public class CRPublishFragment extends Fragment{

    private View view;
    private PullToRefreshListView lv_crowd_record_publish;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:
                    ...
                    break;
                case 2:
                    lv_crowd_record_publish.onRefreshComplete();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_cr_publish , null);
        initView();
        //initData(type , 0);
        return view;
    }
    ...
    private void initData(String type , int start) {
        GetDataBiz.crowdRecord(getActivity() , start, "5", new HttpRequestListener() {
            @Override
            public void onHttpRequestFinish(String result) throws JSONException {
                Log.i("www", "获取众筹抽奖记录" + result);
                lv_crowd_record_publish.onRefreshComplete();
                lv_crowd_record_publish.getLoadingLayoutProxy(true,false).setLastUpdatedLabel("上次更新:"+ TimeUtil.getTime());
    ...
    private void initView() {
        ...
        lv_crowd_record_publish = (PullToRefreshListView) view.findViewById(R.id.lv_crowd_record_publish);
        lv_crowd_record_publish.setMode(PullToRefreshBase.Mode.BOTH);
        adapter = new CRAllAdapter(getActivity());
        adapter.setRecordList(allRecordList);
        lv_crowd_record_publish.setAdapter(adapter);
        lv_crowd_record_publish.setOnRefreshListener(onReFreshListener);
