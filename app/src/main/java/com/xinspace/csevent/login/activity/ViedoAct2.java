 ...
 *
 */
public class ViedoAct2 extends BaseActivity {
    ...
    private String url = "http://ym.lemon95.com/lacel/index/auto?SecretKey=07059c7e010345a3ad302630d78a5315&AppKey=1260758855&Mobile=&NickName=&title=时讯&color=ef5948" ;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        setContentView(R.layout.act_video2);
        initwidget();
        initListener();
...
//				setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        public View getVideoLoadingProgressView() {
            ...
            if (xprogressvideo == null) {
                LayoutInflater inflater = LayoutInflater.from(ViedoAct2.this);
