 ...
 */
public class CRingFragment extends Fragment{
    private View view;
    private PullToRefreshListView lv_crowd_record_ing;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:
                    ...
                    break;
                case 2:
                    lv_crowd_record_ing.onRefreshComplete();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_cr_ing , null);
        initView();
        //initData(type , 0);
        return view;
    }
    ...
    private void initData(String type , int start) {
        GetDataBiz.crowdRecord(getActivity() , start, "5", new HttpRequestListener() {
            ...
            public void onHttpRequestFinish(String result) throws JSONException {
                ...
                lv_crowd_record_ing.onRefreshComplete();
                lv_crowd_record_ing.getLoadingLayoutProxy(true,false).setLastUpdatedLabel("上次更新:"+ TimeUtil.getTime());
    ...
    private void initView() {
        ...
        lv_crowd_record_ing = (PullToRefreshListView) view.findViewById(R.id.lv_crowd_record_ing);
        lv_crowd_record_ing.setMode(PullToRefreshBase.Mode.BOTH);
        adapter = new CRAllAdapter(getActivity());
        adapter.setRecordList(allRecordList);
        lv_crowd_record_ing.setAdapter(adapter);
        lv_crowd_record_ing.setOnRefreshListener(onReFreshListener);
