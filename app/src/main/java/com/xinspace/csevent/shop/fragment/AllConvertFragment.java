...
public class AllConvertFragment extends Fragment {
...
//                    initData(start);
    ...
    public void initData(int start , String flag , String openId) {
        ...
        GetDataBiz.getConvertRecord(openId, start, "0", new HttpRequestListener() {
            @Override
