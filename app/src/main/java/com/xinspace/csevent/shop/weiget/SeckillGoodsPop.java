...
public class SeckillGoodsPop extends PopupWindow {
    ...
    private SeckillDetailBean goodsDetailBean;
    private SDPreference preference;
    private String openId;

    private GridView gv_goods_color;
    ...
    private List<SeckillDetailBean> goodsList;
...
//                    break;
    ...
    public SeckillGoodsPop(Context context, SeckillDetailBean bean, String openid) {
    ...
    private void initView() {
        ...
        goodsList = new ArrayList<SeckillDetailBean>();
        ...
        ImagerLoaderUtil.displayImageWithLoadingIcon("http://shop.coresun.net/attachment/" + goodsDetailBean.getThumb(), img_goods, R.drawable.icon_detail_load);
        ...
        tv_goods_discount_price.setText("¥" + goodsDetailBean.getPrice());
        tv_goods_price.setText("¥" + goodsDetailBean.getMarketprice());
                ...
                case R.id.but_yes:
                    ...
                    if (allOptionList != null && allOptionList.size() != 0){
                        ...
                        if (specId != null && !specId.equals("")){
                            ...
                            orderGoodsBean.setGoodsid(goodsDetailBean.getGoodsid());
...
//                    context.startActivity(intent);
    ...
    private void standardData() {
        String goodId = goodsDetailBean.getGoodsid();
