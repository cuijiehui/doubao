...
public class TrialListAdapter extends BaseAdapter{
...
//            params.width = (int) (screenWidth * 1f);
        ...
        final TrialBean trialBean =  list.get(position);
        ImagerLoaderUtil.displayImageWithLoadingIcon(trialBean.getThumb() , holder.iv_goods_image , R.drawable.goods_loading);

        holder.tv_goods_name.setText(trialBean.getTitle());
        holder.tv_goods_num.setText(trialBean.getTotal());
        holder.tv_apply_num.setText(trialBean.getApply());

        final String success = trialBean.getSuccess();
        ...
        holder.tv_apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (success != null && !success.equals("")){
                    ...
                    intent.putExtra("id" , trialBean.getId());
                    intent.putExtra("success" , success);
                    intent.putExtra("url" , trialBean.getUrl());
