...
public class ExpressAct extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setWindowStatusBarColor(ExpressAct.this , R.color.app_bottom_color);
    ...
    private void initView() {
        ...
        lv_express.setFocusable(false);
        adapter = new ExpressAdapter(ExpressAct.this , allList);
