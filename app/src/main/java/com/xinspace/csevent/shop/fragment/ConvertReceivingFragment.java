...
public class ConvertReceivingFragment extends Fragment {
...
//                    initData(start);
    ...
    public void initData(int start , String flag) {
        ...
        GetDataBiz.getConvertRecord(openId, start, "3", new HttpRequestListener() {
            @Override
    ...
    ResultBean resultBean = new ResultBean() {
        ...
        public void resultBean(int position) {
            ...
            adapter.notifyItemRangeChanged(0, allRecordList.size() - 1);
        }
    };
