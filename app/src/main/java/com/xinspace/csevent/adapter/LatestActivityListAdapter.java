...
public class LatestActivityListAdapter extends BaseAdapter{
    private Context context;
    private List<Object> list;
    private LayoutInflater inflater;


    public LatestActivityListAdapter(Context context, List<Object> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.item_main_activity_list, null);
