...
import com.xinspace.csevent.publish.adapter.PublishAdapter2;
 ...
 *
 */
public class PublishFragment2 extends Fragment{

    private View view;
    private PullToRefreshGridView lv_crowd_publish;
    ...
    private PublishAdapter2 adapter ;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_publish2 , null);
        initView();
        initData();
        return view;
    }
    ...
    private void initView() {
        ...
        lv_crowd_publish = (PullToRefreshGridView) view.findViewById(R.id.lv_crowd_publish);
        lv_crowd_publish.setMode(PullToRefreshBase.Mode.BOTH);

        adapter = new PublishAdapter2(getActivity());
        adapter.setPublishList(allPublishList);
    ...
    PullToRefreshBase.OnRefreshListener2<GridView> onReFreshListener = new PullToRefreshBase.OnRefreshListener2<GridView>() {
...
//                        }
                        ...
                        if ((currentTime2-winTime) < 10 * 60 * 1000 ){
                            publishBean.setDownTime(10 * 60 * 1000 - (currentTime2 - winTime));
                        }else{
                            publishBean.setDownTime(0);
                        }
