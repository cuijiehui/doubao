...
//        RegistBiz.verifyCode(tel, code, new HttpRequestListener() {
//            @Override
...
//                if(res.equals("200")){
//                    //验证码正确
//                    Intent intent=new Intent(FindMyPasswordActivity.this, ResetPasswordActivity.class);
...
//    }
    ...
    private void sendCode() {
        ...
        if(PhoneNumUtil.isPhoneNO(tel)){
            FindbackPasswordBiz.sendCode2(tel, new HttpRequestListener() {
                @Override
                public void onHttpRequestFinish(String result) throws JSONException {
