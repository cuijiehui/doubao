 ...
 *
 */
public class BuyNoPayFragment extends Fragment{
        ...
        GetDataBiz.getUserBuyRecord2( openId , start , "0", new HttpRequestListener() {
            ...
            public void onHttpRequestFinish(String result) throws JSONException {
                ...
                for (int i = 0 ; i < jsonArray.length() ; i++){
                    ...
                    ItemOrderBottom orderBottom = new ItemOrderBottom(getActivity() , allOrderBean , "1" , resultBean);
                    orderContents.add(orderBottom);
                }

                LogUtil.i("未付款订单的数目解析" + recordList.size());
    ...
    private void initView() {
        ...
        rcNoPay.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
