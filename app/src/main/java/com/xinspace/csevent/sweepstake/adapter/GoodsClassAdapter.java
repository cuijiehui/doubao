...
public class GoodsClassAdapter extends BaseAdapter{
    ...
    private List<GoodsClassBean> list = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GoodsClassBean goodsClassBean =  list.get(position);
        ImagerLoaderUtil.displayImage(goodsClassBean.getUrl() , holder.iv_goods_image);
        holder.tv_goods_name.setText(goodsClassBean.getName());
        holder.tv_goods_price.setText("¥" + goodsClassBean.getDiscount());
        holder.tv_goods_price2.setText( "原价" + goodsClassBean.getPrice());
        holder.tv_goods_price2.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
        holder.tv_goods_buy_num.setText(goodsClassBean.getUse() + "人付款");
        return convertView;
    }
