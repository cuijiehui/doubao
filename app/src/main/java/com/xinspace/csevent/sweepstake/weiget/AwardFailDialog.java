...
public class AwardFailDialog extends Dialog {
	...
	public AwardFailDialog(Context context) {
	...
	private void setCustomDialog() {
		...
		View view = LayoutInflater.from(getContext()).inflate(R.layout.award_fail_dialog, null);
