 ...
 */
public class BuyAllRecordFragment extends Fragment{

    private View view;
    private RecyclerView rc_buy_all;
    //private CrowdBuyAllAdapter adapter;
    private int start = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_buy_all_record , null);
    ...
    private void initView() {
        ...
        rc_buy_all.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
