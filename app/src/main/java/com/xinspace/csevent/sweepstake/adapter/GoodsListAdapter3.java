...
public class GoodsListAdapter3 extends BaseAdapter{
    ...
    private List<AppFristGoodsBean> list = new ArrayList<>();
    private LayoutInflater inflater;

    public GoodsListAdapter3(Context context) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
    }

    public void setList(List<AppFristGoodsBean> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AppFristGoodsBean goodsEntity =  list.get(position);
