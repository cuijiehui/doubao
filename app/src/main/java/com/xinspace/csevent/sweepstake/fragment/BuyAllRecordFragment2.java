 ...
 */
public class BuyAllRecordFragment2 extends Fragment{

    private View view;
    private RecyclerView rc_buy_all;
    private int start = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_buy_all_record2 , null);
    ...
    public void onResume() {
        super.onResume();
        LogUtil.i("onResume---BuyAllRecordFragment2");
    ...
    public void onStart() {
        super.onStart();
        LogUtil.i("onStart---BuyAllRecordFragment2");
    }

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        LogUtil.i("onAttach---BuyAllRecordFragment2");
    }

    @Override
    public void onPause() {
        super.onPause();
        LogUtil.i("onPause---BuyAllRecordFragment2");
    }

    private void initData(int start) {
        GetDataBiz.getUserBuyRecord2(openId , start , "", new HttpRequestListener() {
            @Override
    ...
    private void initView() {
        ...
        rc_buy_all = (RecyclerView) view.findViewById(R.id.rc_buy_all);
        allOrderAdapter = new AllOrderAdapter2(getActivity() , allRecordList , resultBean);
        rc_buy_all.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        rc_buy_all.setAdapter(allOrderAdapter);
        initFreshLayout();
    }
    ...
    private void initFreshLayout() {
        refreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.all_record_refreshlayout);
    ...
    ResultBean resultBean = new ResultBean() {
        ...
        public void resultBean(int position) {
            ...
            allOrderAdapter.notifyItemRangeChanged(0, allRecordList.size());
        }
    };
