 ...
 * 待发货
 */
public class BuyNoSendFragment2 extends Fragment{
    ...
    private static final String BUY_STATUS = "1";
    ...
    public void onResume() {
        ...
        LogUtil.i("onResume-----BuyNoSendFragment2");
    }
    ...
    public void onPause() {
        super.onPause();
        LogUtil.i("onPause-----BuyNoSendFragment2");
    }

    private void initData(int start) {
        GetDataBiz.getUserBuyRecord2(openId , start , BUY_STATUS, new HttpRequestListener() {
            @Override
    ...
    private void initFreshLayout() {
        refreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.no_send_record_refreshlayout);
