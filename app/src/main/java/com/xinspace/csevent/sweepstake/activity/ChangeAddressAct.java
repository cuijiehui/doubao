...
public class ChangeAddressAct extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setWindowStatusBarColor(ChangeAddressAct.this , R.color.app_bottom_color);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.img_address_add:
                    Intent intent = new Intent(ChangeAddressAct.this, AddressEditActivity.class);
