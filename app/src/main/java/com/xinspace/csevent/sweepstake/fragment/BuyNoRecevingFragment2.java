 ...
 * 待收货
 */
public class BuyNoRecevingFragment2 extends Fragment{
    ...
    public void onResume() {
        super.onResume();
        LogUtil.i("onResume----BuyNoRecevingFragment2");
        allRecordList.clear();
        start = 1;
        initData(start);
    }
    ...
    public void onPause() {
        super.onPause();
        LogUtil.i("onPause----BuyNoRecevingFragment2");
    }
    ...
    private void initFreshLayout() {
        refreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.no_recive_record_refreshlayout);
