...
/**
 * Created by lizhihong on 2015/11/24.
 * 验证码倒计时
 *
 */
public class TimeCountUtil extends CountDownTimer{
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.btn_register_request_code_shape_duck));
//        Spannable span = new SpannableString(btn.getText().toString());//获取按钮的文字
//        span.setSpan(new ForegroundColorSpan(Color.RED), 0, 2,Spannable.SPAN_INCLUSIVE_EXCLUSIVE);//倒计时时间数字显示为红色
    ...
    public void onFinish() {
        ...
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.btn_register_request_code_shape));//还原背景色
